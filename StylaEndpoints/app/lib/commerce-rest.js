...
CommerceSDK.prototype.login = function () {
    ...
    var loginPromise = new Promise(
        function (resolve, reject) {
            ...
            self.request({
                url: self.applicationContext + '/v1/login',
                method: 'post',
...
CommerceSDK.prototype.logout = function () {
    ...
    var logoutPromise = new Promise(
        function (resolve, reject) {
            ...
            self.post({
                url: self.applicationContext + '/v1/logout', data: {}, callback: function (err, response) {
...
CommerceSDK.prototype.isValidToken = function () {
    ...
    var validPromise = new Promise(
        function (resolve, reject) {
            ...
            self.request({
                url: self.applicationContext + '/v1/verify', method: 'post', data: requestData, callback: function (err, response) {
